...
:::caution
Use [environment variable placeholders](../service/configuration#environment-variable-placeholders) in your Platformatic DB configuration file to avoid exposing credentials.
:::
