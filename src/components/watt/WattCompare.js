  ...
  return (
    <section className='relative w-full overflow-hidden'>
      <div className='hidden md:block absolute z-10 h-[600px] w-[400px]  right-[-160px] bottom-0'>
        <div className='right-focus-bg w-full h-full' />
      </div>
