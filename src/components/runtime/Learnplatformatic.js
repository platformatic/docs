...
const LearnPlatformatic = ({ blok }) => {
  return (
    <div className='relative py-[4rem] px-[4%] flex flex-col items-center border-y border-[#FFFFFF26]'>
      ...
      <span className='text-[1.8rem] md:text-[2.5rem] font-[600] mb-[2.5rem]'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        {blok.learnplatformatic[0].cards.map((card) => (
          <div
            key={card._uid}
            className='flex flex-col w-[100%] mx-auto md:w-[25rem] h-[10.3rem] justify-between items-start p-2 gap-y-2 md:gap-y-4 border dark:border-white/20 border-[#00050b]/30 dark:bg-[#00050b] bg-white rounded-md'
          >
            <div className='flex flex-col'>
              <img src={card.icon} className='w-[2.5rem] h-[2.5rem]' alt='feature icon' />
            ...
            <a
              ...
              className='flex items-center gap-2 text-[1rem] text-[#C61BE2] font-[400]'
            >
