        ...
        <div className='flex-1'>
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col items-center gap-4 border-solid border border-pyellow/20 rounded-xl p-4 py-12'>
              ...
              {/* <a
                href="https://docs.platformatic.dev/docs/getting-started/quick-start-watt"
                className="remove-hvr-alt px-6 md:px-6 py-4 h-full flex items-center justify-center gap-2 rounded-[4px] text-sm text-center w-auto md:w-max  bg-[#00050B] dark:bg-white text-white dark:text-[#00050B] hover:shadow-cta-custom-black dark:hover:shadow-custom-white mx-auto cursor-pointer"
              >
              {render(blok.wa_btn)}
              </a> */}
