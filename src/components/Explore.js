    ...
    <section className="flex flex-col md:flex-row justify-between gap-8">
      ...
      <div className="flex-1">
        <div className="flex flex-col gap-4">
          <div>
            <div className="flex items-center gap-2">
              <div className={`mb-10 ms-4`}>
                <div className="">
                  <div>
                    <div className="text-[14px] md:text-[18px] font-semibold text-pyellow dark:text-pyellow flex gap-2">
          ...
          {/* second */}
          <div className="flex flex-col items-center gap-4 border-solid border border-pyellow/20 rounded-xl p-4">
            ...
            <a
              href={""}
              className="remove-hvr-alt px-2 md:px-4 py-2 h-full flex items-center justify-center gap-2 rounded-[4px] text-sm text-center w-auto md:w-max  bg-[#00050B] dark:bg-white text-white dark:text-[#00050B] hover:shadow-cta-custom-black dark:hover:shadow-custom-white mx-auto"
            >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-4 border-solid border text-center border-pblue/20 rounded-xl p-4">
            ...
            <div className="flex gap-2">
              ...
              <p className="text-base text-white/70 text-left">
...
const Explore = ({ blok }) => {
  ...
  return (
    <section className="z-[5] relative py-10 px-6 md:py-0 md:px-10 flex flex-col items-center border-y border-white/15 shadow-custom-black dark:drop-shadow-md">
      {/* Main container */}
      <div>
        {/* Header section */}
