      ...
      <div className='flex flex-col items-center z-20 relative'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-[1240px] mx-auto w-full'>
          {blok.feature.map((feature, index) => (
            <div
              key={index}
              className='w-[90%] md:w-[37.7rem] mx-auto flex flex-col items-start gap-y-2 md:gap-y-4 p-2 md:p-4 border dark:border-white/20 border-[#00050b]/30 dark:bg-[#00050b] bg-white rounded-md'
            >
