    ...
    <div className='relative py-[4rem] px-[4%] flex flex-col items-center border-y border-[#FFFFFF26]'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
        {blok.learnplatformatic[0].cards.map((card) => (
          <div
            key={card._uid}
            className='flex flex-col w-[100%] mx-auto md:w-[38.7rem] h-[10.3rem] justify-between items-start p-3 gap-y-2 md:gap-y-4 border dark:border-white/20 border-[#00050b]/30 dark:bg-[#00050b] bg-white rounded-md'
          >
            <div className='flex flex-col'>
              <img
                ...
                alt='feature icon'
              />
              <span className='text-left text-[1rem] mt-[1rem] font-semibold'>
                {card.title}
              </span>
            </div>
            <a
              href={card.cta_link.url}
              className='flex items-center gap-2 text-[1rem] text-[#FFFFFFB2] font-[400]'
            >
