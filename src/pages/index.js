            ...
            <div className='max-w-4xl mx-auto flex flex-col justify-center items-center px-2 md:px-0'>
              ...
              <div className='flex flex-row justify-center items-center gap-4 w-full md:max-w-80 max-w-80 mx-auto'>
                <a href='https://www.platformatichq.com/contact' className='flex-1'>
                  <button className='bg-white hover:bg-white/80 hover:translate-y-1 outline outline-white/80 outline-[1px] text-black/80 py-2 px-4 border-none rounded border border-white w-full cursor-pointer text-[14px]'>Get in touch</button>
                </a>
                <a href='docs/getting-started/quick-start-watt' className='flex-1'>
                  <button className='bg-transparent hover:bg-white/30 outline outline-white/80 outline-[1px] text-white py-2 px-4 border-none rounded border border-white w-full cursor-pointer text-[14px]'>Quickstart guide</button>
                </a>
              </div>
            </div>
          </div>
